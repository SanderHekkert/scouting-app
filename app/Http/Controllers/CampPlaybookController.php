...
use App\Http\Controllers\Concerns\CampPlaybookStructuredData;
use App\Http\Controllers\Concerns\CampPlaybookWorkflowMedia;
...
{
    use CampPlaybookStructuredData;
    use CampPlaybookWorkflowMedia;
