    ...
    <GuestLayout>
        ...
        <form class="space-y-4" @submit.prevent="submit">
            ...
            <div>
                ...
                <textarea id="bijzonderheden" v-model="form.bijzonderheden" rows="3" class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-brand-blue focus:ring-brand-blue dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100" />
