...
<template>
    <Head title="Welcome" />
    <div class="bg-app-canvas text-app-muted dark:bg-app-canvas-dark dark:text-app-muted-dark">
        <img
            id="background"
        ...
        />
        <div
            class="relative flex min-h-screen flex-col items-center justify-center selection:bg-brand-blue/25 selection:text-app-ink dark:selection:bg-brand-yellow/30 dark:selection:text-app-ink-dark"
        >
