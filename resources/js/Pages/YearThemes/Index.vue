...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="surface-brand-top rounded-xl border border-app-border bg-app-panel p-4 text-app-ink shadow-sm dark:border-brand-blue/30 dark:bg-app-panel-dark dark:text-app-ink-dark">
            <p class="mb-3 text-xs text-app-muted dark:text-app-muted-dark">
                Dubbelklik op een gekozen thema om te bewerken. Klik daarna ergens buiten het veld om op te slaan. Esc annuleert.
            </p>
